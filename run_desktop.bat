...
if not exist "desktop_ui\index.html" if not exist "dist\index.html" if not exist "index.html" (
    echo [INFO] Local UI directory not found.
    echo [INFO] The app will automatically restore UI components on start.
    echo.
)
